            ...
            <li>
              ...
              <div class="timeline-item">
               <!-- <span class="time"><i class="fa fa-clock-o"></i> 12:05</span>-->
                ...
                <h3 class="timeline-header"><a href="#">Document </a> Details</h3>
                      ...
                      <div class="panel-body">
                          <div class="col-sm-12 col-lg-12 row">
                           <div class="col-sm-12 col-lg-3">
                                  ...
                                  <select class="form-control input-sm" name="customer" id="mySelect" onchange="myFunction()" >
                                  <option>select</option>
                                  <?php
                                      $curesult = mysql_query("select * from customertb where deleted=0");
                           ...
                           <div class="col-sm-12 col-lg-5">.<br>
                              <input class="btn btn-info input-sm" name="getd" type="button" onclick="getdocuments();" value="Get Documents">
                              <a class="btn btn-success btn-sm" href="uploaddocument.php" title="Add Documents"><span class="glyphicon glyphicon-plus"></span></a>
                           </div>
                           <br><br>
                          <div class="col-sm-12 col-lg-12">
                              <div class="box-body" style="height:450px; overflow: auto;"  id="doclist">
