                  ...
                  <form id="addfrm" class="form-horizontal">
                      ...
                      <div class="col-sm-12 col-lg-12 row">
                       <div class="col-sm-12 col-lg-4">
                        ...
                        <input list="countries" name="nationality" class="form-control" placeholder="Enter Country name">
                      <datalist id="countries">
                        ...
                        <div class="col-sm-12 col-lg-4">
                         <label>Address:</label>
                          <textarea name="paddress" class="col-sm-12 col-lg-12 col-md-12 form-control" placeholder="Address" rows="4"></textarea>
                          <br>
                        <label>Mobile (1):</label>
                           <input type="text" class="col-sm-12 col-lg-12 col-md-12 form-control" name="mob1" placeholder="Enter Mobile (1)"><br>
                        <label>Mobile (2):</label>
                           <input type="text" class="col-sm-12 col-lg-12 col-md-12 form-control" name="mob2" placeholder="Enter Mobile (2)"><br>
                        <label>Email - Id:</label>
                           <input type="text" class="col-sm-12 col-lg-12 col-md-12 form-control" name="email" placeholder="Enter Email ID">
                       ...
                       <label>Interested In:</label>
                          <select class="col-sm-12 col-lg-12 col-md-12 form-control" name="intrest">
                              <option disabled selected style="display:none;">Intrested In</option>
                              <option value='Residential'>Residential</option>
                              <option value='Commercial'>Commercial</option>
                            </select><br>
                        <label>Property Description:</label>
                          <textarea name="pdescription" class="col-sm-12 col-lg-12 col-md-12 form-control" placeholder="Property Description" rows="4"></textarea>
                          <br>
...
function add(){  
  ...
  $.ajax({
      ...
      window.location.assign("excprospect.php")
