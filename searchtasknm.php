...
$query ="SELECT *,a.status as mystatus FROM tasktb a,usertb b, prospecttb c,customertb d WHERE a.assignedto=b.uid && a.prospectid=c.prospectid && a.customerid=d.customerid && b.name like '" . $_POST["keyword"] . "%' ORDER BY b.name LIMIT 0,6";
