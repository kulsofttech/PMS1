          ...
          <div class="box">
            ...
            <form id="dtsearchfrm">
              <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                <input class="form-control input-sm" type="text" name="search" id="search-box" placeholder="Search by Invoice Name">
              </div>
                <div class="col-lg-1">
                  <label>Start_Date:</label>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-2 col-lg-2">
                 <input type="date" name="isdate" class="form-control input-sm">
                </div>
                <div class="col-lg-1">
                  <label>End_Date:</label>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-2 col-lg-2">
                 <input type="date" name="iedate" class="form-control input-sm"> 
                </div>
                <div class="col-lg-2">
                  <input type="button" class="btn btn-info btn-sm" value="Get" onclick="searchinvoicedt();">
                </div>
             
              
              <div class="col-xs-12 col-sm-12 col-md-1 col-lg-1">
              <a class="btn btn-success btn-xs" href="addinvoice.php" title="Add Invoice"><span class="glyphicon glyphicon-plus"></span></a>
...
<script>
  function searchinvoicedt(){
    var data = $('#dtsearchfrm').serialize();
//lert(data);
  $.ajax({  
    type: "POST",
    url: "searchinvoicedt.php",
    data: data,
beforeSend: function(){
  ...
  $.ajax({
      ...
      success: function( data ) {
        ...
        for(var i=0;i<data.length;i++){
          var j=i+1;
          var res = "<tr><td>"+j+"</td><td><a target='_blank' href=\"printinvoice.php?id="+data[i]['invoiceno']+"\">"+data[i]['fname']+" "+data[i]['lname']+"</a></td><td>"+data[i]['propertyname']+"</td><td>"+data[i]['unitno']+"</td><td>"+data[i]['invoicestartdate']+"</td><td>"+data[i]['invoiceenddate']+"</td><td>"+data[i]['total']+"</td><td>"+data[i]['mystatus']+"</td><td><a href=\"emailinvoice.php?id="+data[i]['invoiceno']+"\"> Email </a></td></tr>";
