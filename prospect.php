        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header" >
              ...
              <a class="btn btn-success btn-xs" href="addprospect.php" title="Add Prospect"><span class="glyphicon glyphicon-plus"></span></a>
  ...
  $.ajax({
      ...
      success: function( data ) {
        ...
        for(var i=0;i<data.length;i++){
          var res = "<tr><td><input type='radio' name='id' value='"+data[i]['prospectid']+"'></td> <td><a href=\"editprospect.php?Pr_ospI_d="+data[i]['prospectid']+"\">"+data[i]['firstname']+"</a></td><td>"+data[i]['lastname']+"</td><td>"+data[i]['mobile1']+"</td><td>"+data[i]['mobile2']+"</td><td>"+data[i]['emailid']+"</td><td>"+data[i]['nationality']+"</td><td>"+data[i]['status']+"</td><td>"+data[i]['name']+"</td></tr>";
