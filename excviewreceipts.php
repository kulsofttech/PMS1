          ...
          <div class="box">
            ...
            <form id="dtsearchfrm">
              <!--<div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                <input class="form-control" type="text" name="search" id="search-box" placeholder="Search by User Name">
              ...
              <div class="col-lg-1">
                ...
                <div class="col-lg-2">
                  <input type="button" class="btn btn-info btn-sm" value="Get" onclick="searchreceiptdt();">
                </div>
            ...
            <form id="myform" action="addreceipt.php" method="POST" >
              ...
              <center>
                <!--<input type="submit" class="btn btn-success" value="Genrate Receipt">-->
              </center>
            </form>
            </div>
            <!-- /.box-body -->
...
<script>
  function searchreceiptdt(){
    var data = $('#dtsearchfrm').serialize();
//lert(data);
  $.ajax({  
    type: "POST",
    url: "searchviewreceiptdt.php",
    data: data,
beforeSend: function(){
  ...
  $.ajax({
      ...
      success: function( data ) {
        ...
        for(var i=0;i<data.length;i++){
          var j=i+1;
          var res = "<tr><td>"+j+"</td><td><a target='_blank' href=\"excviewprintreceipt.php?id="+data[i]['receiptno']+"\">"+data[i]['fname']+" "+data[i]['lname']+"</a></td><td>"+data[i]['propertyname']+"</td><td>"+data[i]['unitno']+"</td><td>"+data[i]['startdate']+"</td><td>"+data[i]['enddate']+"</td><td>"+data[i]['receiptamount']+"</td><td><a href=\"excemailreceipt.php?id="+data[i]['receiptno']+"\"> Email </a></td></tr>";
