        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header" >
              ...
              <a class="btn btn-success btn-xs" href="addproperty.php" title="Add Property"><span class="glyphicon glyphicon-plus"></span></a>
  ...
  $.ajax({
      ...
      success: function( data ) {
        ...
        for(var i=0;i<data.length;i++){
          var res = "<tr><td><input type='radio' name='id' value='"+data[i]['propertyid']+"'></td> <td><a href=\"editproperty.php?Pr_opI_d="+data[i]['propertyid']+"\">"+data[i]['propertyname']+"</a></td><td>"+data[i]['location']+"</td><td>"+data[i]['country']+"</td><td>"+data[i]['city']+"</td><td>"+data[i]['address']+"</td><td>"+data[i]['description']+"</td></tr>";
          
        $('#propertylist').append(res);
