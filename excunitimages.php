  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
            ...
            <li>
              ...
              <div class="timeline-item">
               <!-- <span class="time"><i class="fa fa-clock-o"></i> 12:05</span>-->
                ...
                <!--<h3 class="timeline-header"><a href="#">Image </a> Gallery</h3>-->
                      ...
                      <div class="panel-body">
                          <div class="col-sm-12 col-lg-12 row">
                           <div class="col-sm-12 col-lg-4">
                                  ...
                                  <select class="form-control" name="proprid" id="mySelect" onchange="myFunction()" >
                                  <option>select Property</option>
                                  <?php
                                      $curesult = mysql_query("select * from propertytb where deleted=0");
                                      for ($i=0; $i <mysql_num_rows($curesult) ; $i++) { 
                                        $propid=mysql_result($curesult, $i,'propertyid');
                                        $pnm=mysql_result($curesult, $i,'propertyname');
                                        echo "<option value=".$propid.">".$pnm."</option>";
                                      }
                                  ?>
                                  </select>
                                  <br>
                           ...
                           <div class="col-sm-12 col-lg-4" id="unitbox">
                           </div>
                           <div class="col-sm-12 col-lg-4" id="unitbox">
                                <label>.</label><br>
                                <input class="btn btn-sm btn-warning" onclick="getimages();" type="button" value="Get Images">
                                <!--<a class="btn btn-success btn-sm" href="uploadimages.php" title="Add Images"><span class="glyphicon glyphicon-plus"></span></a>-->
                           </div>
        ...
        <div class="col-md-12" id="igallery">
        </div>
