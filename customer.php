        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header" >
              ...
              <a class="btn btn-success btn-xs" href="addcustomer.php" title="Add Customer"><span class="glyphicon glyphicon-plus"></span></a>
  ...
  $.ajax({
      ...
      success: function( data ) {
        ...
        for(var i=0;i<data.length;i++){
          var res = "<tr><td><input type='radio' name='id' value='"+data[i]['customerid']+"'></td> <td><a href=\"editcustomer.php?CuS_ToI_d="+data[i]['customerid']+"\">"+data[i]['fname']+"</a></td><td>"+data[i]['lname']+"</td><td>"+data[i]['city']+"</td><td>"+data[i]['country']+"</td><td>"+data[i]['mobile1']+"</td><td>"+data[i]['mobile2']+"</td><td>"+data[i]['custemail']+"</td><td>"+data[i]['custadd']+"</td><td>"+data[i]['notes']+"</td><td>"+data[i]['name']+"</td></tr>";
