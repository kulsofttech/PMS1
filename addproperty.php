                  ...
                  <form id="addfrm" class="form-horizontal">
                      ...
                      <div class="col-sm-12 col-lg-12 row">
                       <div class="col-sm-12 col-lg-4">
                        ...
                        <input type="text" class="col-sm-12 col-lg-12 col-md-12 form-control" name="pname" placeholder=" Property Name"><br>
                        <label> Location:</label>
                        <input type="text" class="col-sm-12 col-lg-12 col-md-12 form-control" name="plocation" placeholder="Enter Location"><br>
                        <label> Country:</label>
                        ...
                        <div class="col-sm-12 col-lg-4">
                          <label> City:</label>
                           <input type="text" class="col-sm-12 col-lg-12 col-md-12 form-control" name="pcity" placeholder="Enter City"><br>
                          <label> Address:</label>
                           <textarea name="paddress" class="col-sm-12 col-lg-12 col-md-12 form-control" placeholder="Enter Address"></textarea>
                        </div>
