  ...
  $.ajax({
      ...
      success: function( data ) {
        ...
        for(var i=0;i<data.length;i++){
          var cnt=i+1;
          var res = "<tr><td> "+cnt+" </td> <td><a href=\"excviewtask.php?id="+data[i]['taskid']+"\">"+data[i]['taskname']+"</a></td><td>"+data[i]['startdate']+"</td><td>"+data[i]['enddate']+"</td><td>"+data[i]['mystatus']+"</td><td>"+data[i]['priority']+"</td><td>"+data[i]['firstname']+" "+data[i]['lastname']+"</td><td>"+data[i]['fname']+" "+data[i]['lname']+"</td></tr>";
          //<a href=\"editprospect.php?Pr_ospI_d="+data[i]['taskid']+"\">   </a>
        $('#tasklist').append(res);
