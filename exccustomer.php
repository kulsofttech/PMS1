  ...
  $.ajax({
      ...
      success: function( data ) {
        ...
        for(var i=0;i<data.length;i++){
          ...
          var res = "<tr><td><a href=\"excviewcustomerunit.php?id="+data[i]['customerid']+"\">"+data[i]['fname']+" "+data[i]['lname']+"</a></td><td>"+data[i]['city']+"</td><td>"+data[i]['mobile1']+"</td><td>"+data[i]['mobile2']+"</td><td>"+data[i]['email']+"</td></tr>";
          
        $('#customerlist').append(res);
